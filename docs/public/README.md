...
Start with the [Phase 1 write-up](phases/phase-1-vgg16-baseline.md) — it links to every methodology document at the relevant points — then read the [Phase 2 write-up](phases/phase-2-architectures.md) for the architecture comparison, and the [Phase 3 write-up](phases/phase-3-xai.md) for the XAI triangulation and the clinical diagnosis of the glioma error mode. Reading them in the order they are referenced gives a natural top-down tour of the project.
